...
//文章内容  汉字 加符号
var CHKCONTENT="^[a-zA-Z0-9\u4e00-\u9fa5\u3002|\uff1f|\uff01|\uff0c|\u3001|\uff1b|\uff1a|\u201c|\u201d|\u2018|\u2019|\uff08|\uff09|\u300a|\u300b|\u3008|\u3009|\u3010|\u3011|\u300e|\u300f|\u300c|\u300d|\ufe43|\ufe44|\u3014|\u3015|\u2026|\u2014|\uff5e|\ufe4f|\uffe5]{2,}$";
				...
				<tbody id="tab_1">
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><textarea rows="15"
								cols="70"  name="content" id="content" ></textarea>
					...
					<tr>
						...
						<td width="80%" class="pn-fcontent"><input type="text"
							class="required" name="author" id="author" maxlength="100" size="50" />
					...
					<tr>
						...
						<select name="channel1" id="cha1">
								<c:forEach items="${LIST1}" var="d1">
									<option value="${d1.id}" name="id">${d1.cname}</option>
								</c:forEach>
						</select>
						<select name="channel.id" id="cha2">
								<c:forEach items="${LIST2}" var="d2">
									<option value="${d2.id}" name="id">${d2.cname}</option>
								</c:forEach>
						</select>
						</td>
					</tr>
					<tr>
						...
						<input type="radio" name="isremod" value="0" />不推荐</td>
					</tr>
					<tr>
